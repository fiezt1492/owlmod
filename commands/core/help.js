            ...
            for (var i = 0; i < content.length; i++) {
              ...
              switch (content[i]) {
                case 'Informations':
                  ...
                  break;
                case 'Fun':
                  des = `TRY NOT TO SPEND ALL YOU MONEY IN THIS CATEGORY!`
                  valued = fun
                  break;
                case 'Player':
              ...
              if (!valued) {
                des = `**Devs Note**: We're still developing this bot, there may be bugs in some command that we can't find out and fix. Let us know at [here](https://discord.gg/542zNAUsPU) or <#877763480978063430>.\n\nChoose your wish category from selections menu below to continue.`
                field = [
                    {
                      name: 'Connections',
